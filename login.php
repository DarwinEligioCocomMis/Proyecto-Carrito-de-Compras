...
<head>
    ...
    <title>Portal de compras | Iniciar sesión | Inscribirse</title>
...
?>
                            ...
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">Dirección de correo electrónico
                                    <span>*</span></label>
                            ...
                            <div class="radio outer-xs">
                                <a href="forgot-password.php" class="forgot-password pull-right">Olvidaste tu
                                    contraseña?</a>
                            </div>
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        <h4 class="checkout-subtitle">Cree una cuenta nueva</h4>
                        ...
                        <form class="register-form outer-top-xs" role="form" method="post" name="register"
                            ...
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail2">Dirección de correo electrónico
                                    <span>*</span></label>
                            ...
                            <div class="form-group">
                                <label class="info-title" for="confirmpassword">Confirmar Contraseña.
                                    <span>*</span></label>
                                <input type="password" class="form-control unicase-form-control text-input"
