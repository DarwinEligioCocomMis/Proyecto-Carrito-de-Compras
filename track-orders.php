            ...
            <div class="track-order-page inner-bottom-sm">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <span class="title-tag inner-top-vs">Ingrese su ID de pedido en el cuadro a continuación y presione
                            Ingresar. Esto se le proporcionó en su recibo y en el correo electrónico de confirmación que debería haber
                            recibió. </span>
