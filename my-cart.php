                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="cart-sub-total item">Costo Envío</th>
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                <div class="shopping-cart-btn">
                                                    <span class="">
                                                        <a href="index.php"
                                                            class="btn btn-upper btn-primary outer-left-xs">Seguir
                                                            Comprando</a>
                                                        <input type="submit" name="submit"
                                                            value="Actualizar carrito de compra"
...
?>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing Address">Datos de Facturación<span>*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing State ">Estado de cuenta
                                                    <span>*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing City">Ciudad de facturación
                                                    <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing Pincode">Código PIN de
                                                    facturación <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
                                            ...
                                            <button type="submit" name="update"
                                                class="btn-upper btn btn-primary checkout-page-button">Actualizar</button>
...
?>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Shipping Address">Dirección de
                                                    envío<span>*</span></label>
                                                <textarea class="form-control unicase-form-control text-input"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing State ">Estado de envío
                                                    <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing City">Ciudad de envío
                                                    <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing Pincode">Código PIN de envío
                                                    <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
                                    ...
                                    <td>
                                        <div class="cart-checkout-btn pull-right">
                                            <button type="submit" name="ordersubmit"
                                                class="btn btn-primary">PROCEDIMIENTO PARA PAGAR</button>
