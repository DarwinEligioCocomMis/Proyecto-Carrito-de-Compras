                                                ...
                                                <div class="add-cart-button btn-group">
                                                    <button class="btn btn-primary icon" data-toggle="dropdown"
                                                        ...
                                                        <a
                                                            ...
                                                            <button class="btn btn-primary" type="button">Agregar al
                                                                Carrito</button></a>
                                                        <?php } else {?>
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>"
                                                class="btn btn-primary"><i
                                                    class="fa fa-shopping-cart inner-right-vs"></i> AGREGAR AL
                                                CARRITO</a>
                                            <?php } else {?>
                                            <div class="action" style="color:red">Agotado</div>
                                            <?php } ?>
                                                    ...
                                                    <div class="review-form">
                                                        <div class="form-container">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputName">Tu Nombre <span
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputReview">Revisar <span
                                                                                class="astk">*</span></label>
                                                            ...
                                                            <div class="action text-right">
                                                                <button name="submit"
                                                                    class="btn btn-primary btn-upper">ENVIAR
                                                                    OPINIÓN</button>
                                                            </div><!-- /.action -->
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="add-cart-button btn-group">
                                            ...
                                            <a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>"
                                                class="lnk btn btn-primary">Añadir al Carrito</a>
