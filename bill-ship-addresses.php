...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('La dirección de envío ha sido actualizadad');</script>";
		}
	}
...
?>
                                                ...
                                                <form class="register-form" role="form" method="post">
                                                    <div class="form-group">
                                                        <label class="info-title" for="Billing Address">Dirección de
                                                            Envios<span>*</span></label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="info-title" for="Billing State ">Estadísticas de
                                                            facturacióne <span>*</span></label>
                                                        <input type="text"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="info-title" for="Billing City">Ciudad de
