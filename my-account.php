                                                ...
                                                <form class="register-form" role="form" method="post">
                                                    <div class="form-group">
                                                        <label class="info-title"
                                                            for="name">Nombre<span>*</span></label>
                                                        <input type="text"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="info-title" for="exampleInputEmail1">Correo
                                                            Electrónico <span>*</span></label>
                                                        <input type="email"
                                                            class="form-control unicase-form-control text-input"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="info-title" for="Contact No.">No.
                                                            Contacto<span>*</span></label>
                                                        <input type="text"
                                                            class="form-control unicase-form-control text-input"
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <form class="register-form" role="form" method="post" name="chngpwd"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Current Password">Contraseña
                                                    actual<span>*</span></label>
                                                <input type="password"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="New Password">Nueva Contraseña
                                                    <span>*</span></label>
                                                <input type="password"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Confirm Password">Confirmar Contraseña
                                                    <span>*</span></label>
                                                <input type="password"
                                            ...
                                            <button type="submit" name="submit"
                                                class="btn-upper btn btn-primary checkout-page-button">Cambiar </button>
                                        </form>
